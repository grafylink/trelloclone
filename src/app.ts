...
function addContainerListeners(currentContainers:HTMLDivElement) {
    const currentContainerDeletionBtn = currentContainers.querySelector('.delete-container-btn') as HTMLButtonElement;
    const currentAddItemBtn = currentContainers.querySelector('.add-item-btn') as HTMLButtonElement;
    const curentCloseFormBtn = currentContainers.querySelector('.close-form-btn') as HTMLButtonElement;
...
function closingFormSubmitListeners(btn: HTMLButtonElement) {
...
function handleDrop(this : HTMLElement, e: DragEvent){
    ...
    if(dragSrcElement.nodeName === "LI" && receptionEl.classList.contains('items-container')){
        (receptionEl.querySelector('ul') as HTMLUListElement).appendChild(dragSrcElement);
        addDDlisteners(dragSrcElement)
        handleItemDeletion(dragSrcElement.querySelector("button") as HTMLButtonElement)
    }
